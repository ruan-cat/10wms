...
const emptyForm: TableData = { goodsCode: "", goodsName: "", specification: "", unit: "" };
...
<template>
	<div class="goods-detail-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看商品详情' : dialogType === 0 ? '新增商品详情' : '编辑商品详情'"
			width="600px"
			:before-close="handleDialogClose"
		>
			<ElForm :model="form" label-position="right" label-width="150px">
				<h2>表单信息管理</h2>
				<ElFormItem prop="goodsCode" label="商品代码："
					><ElInput v-model="form.goodsCode" :readonly="isViewMode"
				/></ElFormItem>
				<ElFormItem prop="goodsName" label="商品名称："
					><ElInput v-model="form.goodsName" :readonly="isViewMode"
				/></ElFormItem>
				<ElFormItem prop="specification" label="规格："
					><ElInput v-model="form.specification" :readonly="isViewMode"
				/></ElFormItem>
				<ElFormItem prop="unit" label="单位："><ElInput v-model="form.unit" :readonly="isViewMode" /></ElFormItem>
			</ElForm>
			<template #footer>
