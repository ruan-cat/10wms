...
const tableColumns = ref<SimpleDataTableColumn<TableData>[]>([
	{ prop: "snroTypeCode", label: "编码类型代码", width: 200 },
	{ prop: "snroTypeName", label: "编码类型名称", width: 200 },
]);
...
<template>
	<div class="encoding-type-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看编码类型' : dialogType === 0 ? '新增编码类型' : '编辑编码类型'"
			width="600px"
