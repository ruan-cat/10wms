...
const tableColumns = ref<SimpleDataTableColumn<TableData>[]>([
	{ prop: "sysConfType", label: "系统参数类型", width: 150 },
	{ prop: "sysConfStep", label: "业务操作环节", width: 150 },
	{ prop: "sysConfOrg", label: "组织", width: 120 },
	{ prop: "sysConfPartner", label: "合作伙伴", width: 120 },
	{ prop: "sysPara1", label: "参数1", width: 120 },
	{ prop: "sysPara2", label: "参数2", width: 120 },
	{ prop: "sysPara3", label: "参数3", width: 120 },
	{ prop: "sysConfText", label: "备注", width: 200 },
]);
...
<template>
	<div class="system-parameter-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看系统参数' : dialogType === 0 ? '新增系统参数' : '编辑系统参数'"
			width="700px"
		...
		>
			<ElForm :model="form" label-position="right" label-width="150px">
				...
				<ElFormItem prop="sysConfText" label="备注：">
					<ElInput v-model="form.sysConfText" :readonly="isViewMode" type="textarea" :rows="3" />
				</ElFormItem>
			</ElForm>
