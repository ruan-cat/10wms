...
<template>
	<div class="expense-type-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看费用类型' : dialogType === 0 ? '新增费用类型' : '编辑费用类型'"
			width="600px"
