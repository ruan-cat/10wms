...
const tableColumns = ref<SimpleDataTableColumn<TableData>[]>([
	{ prop: "unitTypeCode", label: "单位类型代码", width: 200 },
	{ prop: "unitTypeName", label: "单位类型名称", width: 200 },
]);
...
<template>
	<div class="flat-type-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看单位类型' : dialogType === 0 ? '新增单位类型' : '编辑单位类型'"
			width="600px"
