...
/** 表格数据 */
const tableData = ref<ExpenseTemplateRow[]>([
	{
		code: "001",
		name: "按重量计费",
	},
...
/** 表格列配置 */
const tableColumns = ref<SimpleDataTableColumn<ExpenseTemplateRow>[]>([
	{ prop: "code", label: "代码" },
	{ prop: "name", label: "名称" },
...
/** 处理删除 */
function handleDelete(row: ExpenseTemplateRow) {
	console.log("删除", row);
}
...
<template>
	<div class="expense-template-container">
		<el-card shadow="never">
			<template #header>
				<div class="card-header">
					<span class="font-bold">费用类型</span>
				</div>
			</template>
			...
			<el-form :inline="true" class="search-form">
				<el-form-item label="代码">
					<el-input placeholder="请输入代码" clearable />
				</el-form-item>
