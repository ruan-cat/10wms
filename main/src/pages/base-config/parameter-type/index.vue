...
const tableColumns = ref<SimpleDataTableColumn<TableData>[]>([
	{ prop: "syspTypeCode", label: "系统参数类型代码", width: 200 },
	{ prop: "syspTypeName", label: "系统参数类型名称", width: 200 },
]);
...
<template>
	<div class="parameter-type-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看参数类型' : dialogType === 0 ? '新增参数类型' : '编辑参数类型'"
			width="600px"
