...
## <!-- 已迁移到专门的01s文档内 --> 为项目准备好必要的 vscode 插件
...
### <!-- 已迁移到专门的01s文档内 --> 配置 nvm-desktop 的镜像地址
...
## <!-- 已迁移到专门的01s文档内 --> 调出 vscode 的 npm 脚本菜单栏
