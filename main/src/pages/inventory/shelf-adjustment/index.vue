<template>
	<div class="shelf-adjustment-container">
		<ElCard shadow="never">
			<!-- 搜索表单 -->
...
const loadTableData = async () => {
	...
	try {
		const response = await http.requestCompat({
			url: "/api/inventory/shelf-adjustment/list",
			method: "post",
			data: {
				...searchForm,
...
const handleDelete = async (row: any) => {
	try {
		...
		await http.requestCompat({
			url: "/api/inventory/shelf-adjustment/delete",
			method: "post",
			data: { id: row.id },
		});
...
const handleBatchDelete = async () => {
	try {
		...
		await http.requestCompat({
			url: "/api/inventory/shelf-adjustment/batchDelete",
			method: "post",
			data: { ids },
		});
...
const handleSubmit = async () => {
	...
	try {
		...
		const url =
			dialogMode.value === "add" ? "/api/inventory/shelf-adjustment/add" : "/api/inventory/shelf-adjustment/update";
