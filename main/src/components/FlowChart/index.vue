...
function initFlowChart() {
	...
	lf.value = new LogicFlow({
		...
		grid: props.grid,
		stopZoomGraph: props.stopZoomGraph,
	...
	lf.value.on("history:change", () => {
		emit("change", lf.value?.getGraphRawData());
	});

	// 渲染初始数据
	if (props.initialData) {
		lf.value.render(props.initialData);
	} else {
		lf.value.render({});
	}
}
...
function exportJson() {
	...
	element.setAttribute("download", "flow-chart.json");
...
<template>
	<div class="flow-chart">
		<div ref="container" class="flow-container" :style="{ height }"></div>

		<!-- 操作按钮 -->
		<div class="flow-actions">
			<el-tooltip content="导出流程图" placement="top">
				<el-button circle :icon="Download" @click="exportJson" />
			</el-tooltip>

			<el-tooltip content="导入流程图" placement="top">
				<el-upload
