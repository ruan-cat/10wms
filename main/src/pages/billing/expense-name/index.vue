...
<template>
	<div class="expense-name-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看费用名称' : dialogType === 0 ? '新增费用名称' : '编辑费用名称'"
			width="600px"
