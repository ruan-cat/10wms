...
const tableColumns = ref<SimpleDataTableColumn<TableData>[]>([
	{ prop: "unitCode", label: "单位代码", width: 200 },
	{ prop: "unitZhName", label: "单位名称", width: 200 },
	{ prop: "unitEnName", label: "英文名称", width: 200 },
]);
...
<template>
	<div class="measuring-unit-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看计量单位' : dialogType === 0 ? '新增计量单位' : '编辑计量单位'"
			width="600px"
