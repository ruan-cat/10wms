	...
	<div class="moving-count-container">
		<ElCard shadow="never">
			...
			<ElForm :inline="true" :model="searchForm" class="search-form">
				<ElFormItem label="盘点单号">
					<ElInput v-model="searchForm.countNo" placeholder="请输入盘点单号" clearable />
				</ElFormItem>
				<ElFormItem label="状态">
					<ElSelect v-model="searchForm.status" placeholder="请选择状态" clearable>
						<ElOption label="盘点中" value="counting" />
		...
		<ElDialog v-model="dialogVisible" :title="dialogTitle" width="600px" @close="handleDialogClose">
			<ElForm ref="formRef" :model="form" :rules="formRules" label-width="120px">
				<ElFormItem label="盘点单号" prop="countNo">
					<ElInput v-model="form.countNo" placeholder="请输入盘点单号" />
				</ElFormItem>
				<ElFormItem label="仓库编码" prop="warehouseCode">
					<ElInput v-model="form.warehouseCode" placeholder="请输入仓库编码" />
				</ElFormItem>
				<ElFormItem label="盘点人" prop="counter">
					<ElInput v-model="form.counter" placeholder="请输入盘点人" />
				</ElFormItem>
				<ElFormItem label="盘点时间" prop="countTime">
					<ElDatePicker v-model="form.countTime" type="datetime" placeholder="请选择盘点时间" style="width: 100%" />
				</ElFormItem>
...
/** 表格列配置 */
const tableColumns = [
	{ prop: "countNo", label: "盘点单号", minWidth: 150 },
	{ prop: "warehouseCode", label: "仓库编码", width: 150 },
	{ prop: "counter", label: "盘点人", width: 120 },
	{ prop: "countTime", label: "盘点时间", width: 180 },
	{
		prop: "status",
		label: "状态",
		width: 100,
...
/** 表单验证规则 */
const formRules = {
	countNo: [{ required: true, message: "请输入盘点单号", trigger: "blur" }],
	warehouseCode: [{ required: true, message: "请输入仓库编码", trigger: "blur" }],
	counter: [{ required: true, message: "请输入盘点人", trigger: "blur" }],
