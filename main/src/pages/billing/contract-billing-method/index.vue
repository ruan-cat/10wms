...
<template>
	<div class="contract-billing-method-page">
		...
		<el-dialog
			...
			:title="isViewMode ? '查看合同计费方式' : dialogType === 0 ? '新增合同计费方式' : '编辑合同计费方式'"
			width="600px"
