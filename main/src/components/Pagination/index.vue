...
/**
 * 分页组件
 * @description 从 Origin 项目迁移，封装 Element Plus 分页组件，提供自动请求功能
 */
...
<template>
	<ElPagination :="toPaginationProps" v-model:current-page="pageIndex" v-model:page-size="pageSize">
		<!-- 插槽支持 -->
		<slot></slot>
	</ElPagination>
</template>
...
// 分页组件样式由 Element Plus 提供，自动适配主题
</style>
